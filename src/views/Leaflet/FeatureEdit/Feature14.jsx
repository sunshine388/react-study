  ...
  return (
    <React.Fragment>
      <div className='map_container'>
        <div id='preview14' className='preview'>
          <div className='loading'></div>
          <span>正在删除，请稍候</span>
        </div>
        <div className='ToolLib'>
          请输入要删除的线要素ID:
          <select id='featureID14' onChange={onSelect}></select>
          <input
            type='button'
            value='矢量图层删除线要素'
            onClick={deleteLine}
        ...
        <div id='map14' className='map'></div>
      </div>
    </React.Fragment>
  );
}
