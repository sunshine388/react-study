    ...
    <React.Fragment>
      <div className='map_container'>
        ...
        <div className='ToolLib'>
          请输入要删除的要素ID：
          <select id='featureID5' onChange={onSelect}></select>
          <input type='button' value='删除要素' onClick={deleteLine} />
        </div>
