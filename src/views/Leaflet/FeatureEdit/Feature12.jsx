        ...
        for (let i = 0; i < a.SFEleArray.length; i++) {
          ...
          x =
            featureBound.xmax !== featureBound.xmin
              ...
              : featureBound.xmax;
          y = featureBound.ymax = featureBound.ymin
  ...
  return (
    <React.Fragment>
      <div className='map_container'>
        <div id='preview12' className='preview'>
          <div className='loading'></div>
          <span>正在更新，请稍候</span>
        </div>
        <div className='ToolLib'>
          请输入要更新的点要素ID
          <select id='featureID12' onChange={onSelect}></select>
          <input type='button' value='更新点要素' onClick={updatePoint} />
        </div>
        <div id='map12' className='map'></div>
      </div>
    </React.Fragment>
  );
}
