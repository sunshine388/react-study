    ...
    <React.Fragment>
      <div className='map_container'>
        ...
        <div className='ToolLib'>
          请输入要删除的要素ID：
          <select id='featureID8' onChange={onSelect}></select>
          <input type='button' value='删除区要素' onClick={deleteRegion} />
        </div>
