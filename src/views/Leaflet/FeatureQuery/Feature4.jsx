  ...
  return (
    <React.Fragment>
      <div className='map_container'>
        <div id='preview4' className='preview' style={{ display: 'none' }}>
          <div className='loading'></div>
          <span>正在查询，请稍候</span>
        </div>
        <div className='ToolLib'>
          <input type='button' value='固定矩形查询' onClick={query} />
        </div>
        <div>
          该示例为矢量地图文档固定矩形查询(返回查询结果JSON)接口示例，请注意：
          <br />
          &nbsp;&nbsp;&nbsp;&nbsp;1、默认查询示例数据库（OpenLayerVecterMap.hdf）下“世界地图经纬度”中的简单要素类“世界政区”，操作前请先确认此数据库已经附加，地图文档（WorldJWVector）已经发布；
          <br />
          &nbsp;&nbsp;&nbsp;&nbsp;2、用于查询的固定矩形由(93, 35), (111,
          56)两个点构成，点击【固定矩形查询】按钮执行查询。
          <br />
        </div>
