...
export default function Analysis9View() {
  const initMap = () => {
  ...
  const OverlayByPolyAnalysis = () => {
    ...
    //设置叠加空间几何信息
    // eslint-disable-next-line
    let geoRegion = new Zondy.Object.GRegion(
      [
        // eslint-disable-next-line
    ...
    // eslint-disable-next-line
    let overlayParam = new Zondy.Service.OverlayByPolygon({
      //访问IGServer的IP
