...
import './CustomControlRender.scss';
import { fabric } from 'fabric';

class CustomControlRenderView extends Component {
  state = {
    canvas: null
  };
  // 初始化
  ...
  addRectangle = () => {
    ...
    this.state.canvas.add(rect); // 将矩形添加到画布中
    this.state.canvas.setActiveObject(rect); // 并选中刚添加的矩形
  };
  ...
  render() {
    return (
      <div className='box'>
        <button onClick={this.addRectangle}>添加长方形</button>
        <canvas
          id='canvas'
          width='600'
          height='600'
        ...
        <div>
          代码出处{' '}
          <a
            href='http://fabricjs.com/custom-control-render'
            target='view_window'>
...
export default CustomControlRenderView;
